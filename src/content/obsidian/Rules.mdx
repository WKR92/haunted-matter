...
- **Buying Effects with Successes** — if you roll more than 1 success, you may convert each of them into an additional effect, such as a **maneuver**, movement, using an item, etc. Converting each excess success costs **fatigue**.
...
- **DISARMED** — each damage die deals +1 additional damage to them (does not stack with identical effects). Disarming throws the weapon into an adjacent zone chosen by the one performing the **maneuver**. Picking up the weapon costs a move/action/(**fatigue** + **disadvantage**) — player’s choice.
