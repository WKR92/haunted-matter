...
- Use it when **P** are acting under pressure — breaking into someone’s house, checking cabinets behind someone’s back, running out of time, searching for someone in danger, etc. They are accompanied by an **Alarm Clock** with a number of segments equal to the number of **advancing rolls** — usually 4–6 — and when it fills, narrative consequences occur.
  - By design, **P** should fail to get out of a pressured situation unless they roll full successes or decide to abandon the action before interacting with everything that might yield potential value.
