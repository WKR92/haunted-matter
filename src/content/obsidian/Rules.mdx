...
- **Summoner** — you may use summoning according to its rules (see Magic) — when purchasing this power, define the appearance of your summons; you cannot change this later unless the narrative allows it — likewise, when purchasing this power choose the associated **attribute**: **arcana/nature/religion/will** — costs 2 **fatigue**.
- **Echo** — when purchasing this power, choose the associated **attribute**: **arcana/nature/religion/will** — you can create clones according to their rules (see Magic) — costs 2 **fatigue** — can be performed as an action or a movement.
