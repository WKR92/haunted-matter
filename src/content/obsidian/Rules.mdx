...
| 3  | NARROW      | Max 2 creatures. **Disadvantage** on attacks/magic. Each damage die deals 1 damage less. A group must spend an action on movement to pass through — it cannot stop inside.                                                                                    | corridor, canyon          |
