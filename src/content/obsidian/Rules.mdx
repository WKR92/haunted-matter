...
|7|	Time within an area of several dozen km² is torn apart: people age, reverse, or loop randomly (roll 5k6 years in either direction); some individuals “fall out” of history.|
...
| 85   | Druidic Symbol                    | e.g. a circular rune woven from branches — occupies one hand — pay 2 **fatigue** to apply the **ENTANGLED condition** to all targets in 2 adjacent zones — if a powerful enemy is among them, roll k6 to determine the **main die** result — none of the affected targets can free themselves from this **condition** before your next turn (**P** tracks it) — reaches up to 2 zones away from you.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
- If a **P** didn’t make any roll during their turn — for example, only moved or lit a torch — the enemy may react as if it had scored a **partial success**, dealing **1 die of damage**.
    - In this case, the enemy reaction clock (see *Enemy Control by the GM*) advances as if the **main die** rolled a 6, and this does not activate any enemy abilities.
    - If **P** applied a condition to an enemy that requires resolution with a test (or a similar effect), and **P** did not make any test during this turn, the **G** rolls k6 × enemy scale (1-weak, 2-standard, 3-strong, 4-mighty) for the purpose of that resolution.
...
- **SLOWED / FAST** – if you move, you have **disadvantage** / you may move once more or roll with **advantage** – typically lasts 2 turns – any flying or mounted creature has the **FAST** condition, but it’s a sustained effect that can be interrupted - overlapping prolongs the effect.
...
- **STUNNED** – the target loses their turn, and any action against them counts as a full success – each damage die deals +2 additional damage, and the target can’t use Armor - overlapping extends the effect.
...
- Enemies can use **powers** just like **P**: they pay 1 HP to do so, or they may use a power when the **P** rolls 1 (or 1–2 for stronger foes) on the **main die**.
...
- **Choosing which enemy reacts:**
    - Pick the one that best advances the fiction. If you want more ramdomness, use this schema:
        ...
        - If **P** did not make any roll during their turn, the enemies **reaction clock** advances as if the **main die** rolled a 6, but this does not activate any enemy abilities.
...
Rituals require the sacrifice of a **treasure, component, resource and material**, a **downtime action**, as well as a **quiet, uninterrupted place**.  
On a **partial success**, if the **P** wants the ritual to succeed, they must pay 4 **development points**.
...
- Each genuine argument from **P** that the **GM** recognizes as truly affecting the fiction (not just eloquence or logic, but an actual change in the fictional situation) grants **P** k6/2 (1–2: 1, 3–4: 2, 5–6: 3) **advantages**, which **P** may distribute freely within the party.  
