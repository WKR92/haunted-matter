...
| Result                  | Effect |
| ----------------------- | ------ |
| ❌ **Failure**           | **P** either advance the success clock + roll **d6 × remaining segments of the failure clock**, where each 1–3 advances the **failure clock** by 1, OR **P** do not advance the success clock + roll **d6 × remaining segments of the failure clock**, where each 1–2 advances the **failure clock** by 1 and a consequence segment appears. The appropriate option depends on the narrative; if failing a given stage would make further progress impossible, use the variant with a consequence segment. |
...
- When rolling to advance the **failure clock**, **P** never roll more than 6d6, even if the clock has more segments.
...
- **Secrets**
  ...
  - Secrets are the only part of the procedure that increase the number of possible actions **P** can take beyond the number of segments of the **Alarm Clock** — and this is exactly their purpose — so they should be used with their nature in mind.
