...
| 85   | Druidic Symbol                    | e.g., a circular branch-woven rune — occupies a hand — spend 2 **fatigue** to inflict **ENTANGLED** on everyone in the zone — if a powerful enemy is among them, roll 2d6 to determine the **main die** result — none of the affected can move until your next turn, even if they break the condition — 2 zones reach.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
