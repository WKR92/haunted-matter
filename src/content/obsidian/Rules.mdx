...
- A magical catastrophe is a rare, extreme event in which the action of a user of magic escapes the local scale and causes irreversible consequences for the surroundings, a region, or the order of the world. It is not a “failed use of power”, but a moment in which reality responds in a disproportionate, brutal, and lasting way. The effects of a catastrophe always remain in the world and cannot be undone by simple means.
- A magical catastrophe can be triggered not only by casting spells (**arcana, nature, religion** traits), but also by major supernatural **powers**, arcana (magical items), rituals, scrolls, and elixirs (during the first test made after their use — any **trait**).
    - If an arcane item triggers a magical catastrophe, it is destroyed.
- A magical catastrophe occurs only if P rolls at least 3 dice and the result is < (sum of dice × 2) − 1, which gives approximately a ~1.6% chance — when this happens, roll an effect from the table below.

|No.|Effect|
|---|---|
|1|	Around the source of the catastrophe (but not within it), in an area of several dozen km², an impulse spreads that introduces one non-permanent disturbance of reality, chosen by the MG, e.g. everyone loses their eyes, shadows detach from people and begin to live their own lives, no one can die — but dies the moment they cross the boundary of the disturbance, all affected fetuses are born as demons, etc.|
...
|3|	A region of several dozen km² is covered by dark clouds that block out the sun for a year; unbroken night, cold, crop failure, and famine follow.|
|4|	An area of several dozen km² is permanently tainted by one lasting curse chosen by the MG.|
|5|	Around the source of the catastrophe, a sphere of several dozen km² forms in which the laws of the world and physics function differently; the anomaly is permanent and begins to affect surrounding areas, e.g. everything drifts in the air as if underwater and movement is only possible by swimming, or the sky falls to the ground, etc.|
|6|	An earthquake strikes an area of several hundred km²: cities breaks, rivers change course, coastlines shift, maps become obsolete.|
|7|	Time within an area of several dozen km² is torn apart: people age, reverse, or loop randomly (roll 5d6 years in either direction); some individuals “fall out” of history.|
|8|	The effect that triggered the catastrophe is multiplied across an area of several dozen km² and grotesquely warped, e.g. a healing spell causes wounds to fuse with the wounds of other people or with the surroundings.|
|9|	Around the source of the catastrophe, a sphere of several dozen km² forms in which the land and nature come alive — soil, stone, and terrain become conscious.|
