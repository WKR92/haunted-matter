...
- A magical catastrophe can be triggered not only by casting spells, but also by supernatural powers (strong and weak), arcana, scrolls, and elixirs — on every roll connected to them / under their influence (e.g. while an elixir is active).
