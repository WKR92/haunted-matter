...
| 8  | OBSCURED    | **Disadvantage** on attacks/magic for creatures inside and against creatures inside. Double **advantage** on **stealth**. Cancels the **disadvantage** to stealth from having enemies in the same zone. Creatures with **hidden/invisible** get 1 extra move. | fog, smoke, darkness      |
