...
- **Mechanics:** Success clock advances (+1). The **failure clock** has 6 empty segments, so Player A rolls **4d6** (because the maximum is the total number of **Failure Clock** segments minus 2) for failure (1–2 advance the clock).
