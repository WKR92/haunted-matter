...
- **CHARMED** – doesn’t affect monsters – at the start of your turn you test **will** – full success: you break the charm and act with **disadvantage**; partial: you may spend **fatigue** to break free at the end of the turn, but until then the enemy controls your movement and action, using the failures from this Rolling; failure: the enemy fully controls you – if you are the one who charmed them, you may give them an order as long as it doesn’t violate their values.
