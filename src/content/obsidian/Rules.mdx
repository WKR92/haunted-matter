...
- **Assassin** — if you have **numerical advantage**, you may pay 1 **fatigue** to make your next attack with 5 dice; works only in melee and only if you have no armor penalties to agility.
