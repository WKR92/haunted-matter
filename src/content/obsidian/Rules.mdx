...
- **One-handed** (e.g. sword, mace):
  - You may hold a **shield**, **light source**, or **utility item** in your other hand.
  - Fighting with **two one-handed weapons**:
    - on a 4–5 on the **main die**, it does not break hiding unless you roll a failure.
    - you may add **advantage** to each attack, but that attack cannot result in a full success.
- **Two-handed** (e.g. axe, hammer) — each success deals **3 damage** instead of 2 — takes 2 equipment slots.
...
- Reload cost = 1 **fatigue** (each subsequent reload in the same scene costs +1 additional **fatigue**; ending your turn in a **COVERED** zone resets the counter) / or an action.

|Weapon|Inventory slots|Rules|
|---|---|---|
|**Shortbow**|1|No penalties for shooting from a mount; on 4–5 on the **main die** the attack does not break hiding unless you roll a failure.|
|**Bow**|1|You may distribute the successes of an attack among multiple targets (you cannot injure targets against whom you had **disadvantage** if you did not roll with **disadvantage**), and on a 4–5 on the **main die** (2–3 for enemies), you apply the **SLOWED condition** to each of them if you dealt damage.|
|**Crossbow**|2|On 2–3 on the **main die** it requires reloading; success = 3 dmg, **armor piercing** 1.|
|**Light crossbow**|1|On 2 on the **main die** it requires reloading; **armor piercing** 1.|
|**Repeating crossbow**|2|Requires reloading after 3 shots; **armor piercing 1**. On a 5 on the **main die**, it pushes the target 1 zone.|
|**Hand crossbow**|0/5|May be combined with a melee weapon; attack = melee or ranged; range: 1 zone only and requires reloading after each shot; on a 4–5 on the **main die**, the attack does not break hiding unless you roll a failure.|
|**Musket**|2|On 2 on the **main die** you gain **DEAFENED condition**; on 3 it requires reloading; success = 3 dmg, **armor piercing** 2; after the attack, you cannot remain hidden in any way.|
|**Pistol**|0/5|May be combined with a melee weapon; attack = melee or ranged; **armor piercing** 2; requires reloading after each shot; after the attack, you cannot remain hidden in any way.|
...
- **Improvised weapon** (broken bottle, broom handle, etc.): 2 damage per success.
  - After a successful attack, it is destroyed unless the **main die** shows 4–5.
...
|**Small shield**|+1|–1 to **agility**|Takes 1 slot. Can be **sacrificed** to: – reduce damage by 4 or avoid a **maneuver/condition/status**. Sacrificing it weakens the grip of the hand that held the shield — until the end of the scene, you cannot use other shields, dual-wield weapons, two-handed weapons, or similar equipment. |
|**Large shield**|+2|–1 to **agility** and **visibility**|Takes 2 slots. Can be **sacrificed** to: reduce damage by 6 or avoid a **maneuver/condition/status**. Sacrificing it weakens the grip of the hand that held the shield — until the end of the scene, you cannot use other shields, dual-wield weapons, two-handed weapons, or similar equipment. Additionally, you may spend an action to choose one border of your zone and, until your next turn, become immune to **maneuvers** and block the line of fire/directional spell through that border or from its diagonal for enemies on the map, forcing them to target only the zone in front of you or you as the shield bearer. |
...
- **Medic** – treat an ally (not yourself) in the same zone; heal them for 1d6 or remove 2 **fatigue**. Costs an action. Only one **P** in the group can have this power.
- **Mobile** – move freely through 2 zones, including dangerous terrain (like climbing) or past enemies; you can also break a grapple (doing so reduces your extra movement to 1 zone). Costs an action unless you take **disadvantage**. Outside combat: for 1 **fatigue**, it grants you **advantage** on an **athletics** test to determine whether you catch up to someone or reach a place first.
- **Finesse** – your next attack ignores enemy armor. Can’t be used with two-handed weapons - each subsequent use in the same scene costs 1 additional **fatigue**.
- **Defender** — until your next turn, you are immune to **maneuvers** and you intercept the effects of the next targeted attack/spell/**maneuver** that would hit any/specific ally in the same zone as you (you do not choose the type — you are ready for any of them); that attack deals 1 fewer damage die to you, and if it is a **maneuver**, it is blocked and has no effect; effects bought with excess successes as part of the defended action cannot take effect (e.g. if an enemy deals damage with one die and converts another die into a push by paying 1 HP, you intercept all effects of that action); using this outside your turn costs 2 **fatigue**, imposes a **physical status**, and is possible only once per combat.
- **Armored** – regain up to 1d4 armor points. Costs an action; each additional use in the same scene costs 1 more **fatigue**.
- **Silent** — outside combat: you may appear unnoticed in a place within line of sight (this is not teleportation — you do not bypass barriers, locks, or difficult terrain; you must have a real path to reach it); in combat: you grant yourself the **HIDDEN condition**, which functions as if you had +1 **stealth** (even beyond the 4-dice limit), and you may attempt to hide 1 additional time beyond the limit set by your trait (after applying the bonus from this **power**); maximum 3 times.
...
- **Brutal** – your next attack deals +1 damage per success - each subsequent use in the same scene costs 1 additional **fatigue**.
- **Unyielding** — you may ignore a **condition**/**maneuver** at the moment it would affect you by paying 1 **fatigue** (each use in the same scene costs 1 additional **fatigue**), or you may ignore a **status** in the same way, but the base cost for doing so is 2 **fatigue**; you may do this only once per combat, and after the combat ends, the status returns.
...
- **Supportive** – turn an ally’s failure into a partial success (once die). Combat only. Each additional use in the same scene costs 1 extra **fatigue**.
- **Shieldbearer** — you may sacrifice your shield to protect an ally standing in the same zone as you, according to the shield sacrifice rules; you may hurl your shield as a thrown weapon using **aiming** (2 damage on a success) for 1 **fatigue**; you may choose for blocking a line of fire with a large shield to cost you a move and **fatigue** instead of an action; if you use a small shield, you may also sacrifice it for a purpose other than defense and perform a free move/**maneuver** outside your turn (only at the end of an enemy’s action).
...
- **Disruptor** — you create a disturbance (e.g. a shout, whistle, knocking something over) that, until your next turn, draws attention away from a chosen creature/object within 2 zones (it cannot become the target of any action — the enemy must always choose another target); costs an action; each use in the same scene costs 1 additional **fatigue**; does not protect against area effects; using it outside combat costs 2 **fatigue** and grants the possibility of a single reaction before the enemy.
- **Monk** — your unarmed attacks permanently deal 2 damage per success (you do not need to pay **fatigue** for this), even if you are holding something in one hand; for 1 **fatigue**, you may run along walls, but you cannot remain on them longer than 1 turn (unless you extend the effect by paying additional **fatigue**); additionally, for 1 **fatigue**, you gain an extra move this turn and must use both moves (you cannot end your turn in a zone you have already been in this turn); your next unarmed attack deals +1 damage die (if it succeeds) for each unique zone you passed through this turn beyond the starting and first zone; during this action, you may run along walls for free; each subsequent use in the same scene costs 1 additional **fatigue**.
...
- **Swing** – split the damage dice of your melee/unarmed attack among any combination of targets in your zone (at least 2); you may decide that this attack cannot result in a full success in order to make it with **advantage**; if you have **armor penetration**, it applies to each target.
- **Berserker** – costs 1 **fatigue** per turn; lasts until you stop it (only at the start of your turn) or your HP reaches 0. You enter a rage, losing control but gaining strength: attack with **advantage**, your successes deal 4 damage, gain armor piercing 1, but lose armor and treat full successes as partial - the first **critical damage** test during its duration has **advantage**, and you do not lose any **critical damage dice** because of it..
- **Executioner** – if your next melee attack kills the target, deal 4 damage to another creature in the same zone - each subsequent use in the same scene costs 1 additional **fatigue**.
- **Assassin** — if you have **numerical advantage**, you may pay 1 **fatigue** to make your next attack with 5 dice; works only in melee and only if you have no armor penalties to agility - each subsequent use in the same scene costs 1 additional **fatigue**.
- **Trapper** — costs an action — mark the zone you are in or an adjacent one for 2 turns and roll **survival/stealth**; on a failure, enemies spot the trap or it proves ineffective; otherwise, the first enemy who enters that zone is **knocked prone** at the end of their action and takes 3 damage; the trap then disappears; assign the result of your **main die** to the trap in order to resolve its effect if it is triggered by a **powerful enemy**; you may spend a move/action to shift an already placed trap by 1 zone if it is in your zone or an adjacent one (within range only); when an enemy triggers a trap, you may pay 1 **fatigue** to immediately place another trap for free within range (this happens outside your turn); you may have a number of traps placed at once equal to your **survival/stealth** − 1; **P** track duration and remind about trap activation.
- **Marksman** – outside combat: you can hit any target within range, as long as the shot is not lethal and does not cause extreme maiming (e.g. eye, genitals). When shooting at fleeing targets, you may pay **fatigue** to gain **advantage**. In combat: for 1 **fatigue**, you may either ignore the penalty for shooting in a zone containing an enemy, or make your next shot (if not a failure) push the target 1 zone and apply **PRONE**.
- **Hunter** – you may pay 1 **fatigue** to mark a target within 2 zones for 2 turns. If your attack against the marked target is a success, you deal one additional damage die. The mark ends if the target moves more than 2 zones away from you or enters your zone. If the marked target dies before the mark expires, you may immediately perform a tactical move; if you do, you may transfer the mark to another target within range. Only one mark at a time. Works only with ranged weapons — if you change or lose the weapon, the mark ends.
- **Ranger** – you may pay 1 **fatigue** to mark a target within 2 zones for 2 turns. Each turn, you deal 2 damage to that target if it is not your primary target (additional covering fire). The mark ends if the target moves more than 2 zones away from you or enters your zone. If the mark expires and you maintained distance for its full duration, you may immediately perform a tactical move; if you do, you may transfer the mark to another target within range in a zone that does not already contain a marked target. Maximum 2 marks at once. Works only with ranged weapons — if you change or lose the weapon, all marks end.
- **Tamer** – your next attack, if it hits (it does not need to deal damage), applies the **FRIGHTENED condition**; costs 2 **fatigue** and works only once per given creature.
- **Guardian** — until your next turn, you are immune to **maneuvers** and block entry into your zone from up to two adjacent zones that must border each other; enemies in those zones may attack you in melee as if you were standing in their zone (you are considered to be holding the edge).

Non-combat:

*They affect non-critical elements and create an opening/advantage rather than providing a final resolution.*

- **Tracker** – instantly find a nearby track if it exists, or erase your and your party’s tracks.
- **Immortal** – you can reroll 1 **critical damage die**.
- **Thief** – steal or take something small and non-key unnoticed within reach, even in a tense situation.
...
| 58   | Winged Armor                      | light armor + pay 2 **fatigue** — wings sprout from your back, letting you fly for 4 turns (including current one).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
- There is no initiative — **P** always begin. The first to act is whoever has an idea, then play proceeds clockwise. The order never changes unless someone is knocked down, in which case they act last. A **P** may always choose to act last. If **P** are surprised, they have **disadvantage** on all rolls during their first turn.
...
- Enemies have no turns. They act only in reaction to the **P**’s moves. On a **partial success** or **failure**, enemies act effectively; on a **full success**, their attempts fail. Only one enemy reacts mechanically to the move of a single **P** (though narratively they may act as a group). Usually, the last roll in a **P** turn should determine the enemy’s reaction — most of the time **P** roll only once per turn.
- Interpretation of die results:
  - highest result: **6** → full success for **P** → after **P** act, the enemy only gets a move and performs a narratively failed action (e.g. their attack misses).
  - highest result: **4–5** → partial success → after **P** act, the enemy gets a move and one action.
    - Double 5 (without a 6): ignore failures showing 3.
  - highest result: **1–3** → failure → after **P** act, the enemy may take a move and 2 actions.
- Damage:
...
- As your action, you may use **preparation** to set a reaction to a specific trigger, e.g. “I strike as soon as someone crosses the threshold of this room” or “when someone approaches me.”
  - By choosing this action, you end your turn without a roll, and the enemy acts as if you had rolled a partial success with one damage die. If your prepared action is:
    - Attack: you deal 3 damage.
    - Maneuver: it succeeds without a roll.
    - Defense: you block one enemy damage die or 1 **fatigue**.
  - By choosing this action, you risk that the trigger may never occur.
- **Numerical advantage** in the zone grants +1 to every damage die. Leaving a zone where enemies have **numerical advantage** costs one **fatigue**.
...
- **Maneuvers**: instead of attacking, you may attempt **maneuvers** (such as blinding, knocking down, pushing, etc.). Performing the same **maneuver** against the same target turn after turn imposes **disadvantage**. Maneuvers against larger creatures are made with **disadvantage**. Moving someone with a **maneuver** does not count as the target’s movement and does not expose them to additional costs (such as **fatigue** for leaving a zone where enemies have **numerical advantage**).
- **Ranged Combat:**
...
- **Hiding in Combat**:
    ...
    - You may spend 1 turn of duration to:
        ...
        - Add 1 guaranteed success to your attack (counts as at least a partial success; if you roll higher, you may reach a full success; you immediately gain 1 damage die) - only once per attack.
...
- **Powerful enemies / bosses:**
    ...
    - Each zone they occupy, in addition to its own effects, also applies the effects of a **DANGEROUS** zone to their enemies — this does not stack **statuses** if the zone is already **DANGEROUS**.
...
- If **P** roll a partial success and there are no failures on the dice, the enemy performs a **maneuver**, takes an additional move, or enters **defense** (the first attack against them before their next turn has **disadvantage**).
- **Turns with no roll**:
  - If **P** make no roll during their turn (e.g. they only move and light a torch), the enemy may react as if there had been a partial success with one damage die.
  - During such a turn, the enemy reaction clock (see Enemy Control by the **GM**) advances as if the **main die** showed a 6, and no enemy abilities are activated.
  - During such a turn, if **P** applied an effect to an enemy that requires a roll to resolve (e.g. the **CHARMED** condition) and there is no **main die** result to determine that effect, **P** roll d6 to establish the **main die** result solely for resolving that effect.
...
Those mechanics are recommended.

- **Buying Effects with Successes** — if you roll more than 1 success on your action, you may convert each of them into an additional effect, such as a **maneuver**, movement, using an item, etc. Converting each excess success costs **fatigue**.
    ...
    - An attack must always be your first action; only after it do you resolve any purchased actions in any order. If your first action is not an attack, you may not attack with any other purchased actions that turn.
    - Opponents can use this mechanic just like **P**.
    - If an action has **disadvantage** and you want to perform it by spending purchased successes (e.g. pushing a creature much larger than yourself), you must spend 2 excess successes for it to succeed.
- **Mounted combat**:
...
- **Flying**:
  - A flying creature is treated as if it had the **FAST condition**.
  - Flying creatures can be knocked down by interrupting a sustained effect; this applies **fatigue** and the **PRONE condition**.
  - Flying allows vertical movement, as if there were a second layer above the zone map in which all zones are **NEUTRAL** ( **ELEVATED zones** are treated as belonging to this layer).
  - Taking off upward or descending downward may occur together with changing zones, but it always costs a move — even if it happens within the same zone.
    - E.g. a melee attack from the air always ends on the ground, unless the flying creature spends an **advantage** from the **FAST condition** for an extra move or has another way to ascend again.
  - When ascending or descending while simultaneously changing zones, the restrictions of those zones must be taken into account, e.g. walls of a **SEPARATING** zone or prohibitions on diagonal movement.
  - A flying creature that falls is immediately affected by the zone it lands in.
  - From ground-level zones, you cannot make melee attacks against flying creatures in the higher zone layer, unless it is an **ELEVATED zone**.
  - Ranged attacks made from the ground against targets in the higher zone layer have −1 range, unless it is an **ELEVATED zone**.
  - If a flying creature is knocked down twice during a fight, it cannot fly again until the end of the encounter — the number of knockdowns persists even if the creature temporarily loses flight and later regains it.
  - By default, temporary flight lasts 3 turns (4 for someone who applied it to themselves and whose turn is still ongoing). If the last of those turns ends while still in the air, the creature falls (unless it is an **ELEVATED zone**, in which case they simply stand on the ground, as they were already at that height), and this counts as a knockdown.
  - You cannot benefit from flight if it is physically impossible — e.g. a flying creature fighting inside a low building does not gain the **FAST condition** and cannot move up or down.
  - A flying creature that ended its turn on the upper layer of a zone does not count toward **numerical advantage**.
- **Walking on Walls and Ceilings**:
  - Works under the same rules as flying, with the following differences:
    - It does not grant the **FAST condition**.
    - The number of knockdowns does not affect the ability to continue.
    - Moving onto the ceiling (the upper zone layer) requires a move and is possible only in zones that physically allow it (walls, trees, etc.).
    - Moving onto a wall does not require a move and is possible only in zones that physically allow it (walls, pillars, etc.), but a **P** who declares they are on a wall is still treated as being in the same zone and is affected by all its effects — though they gain melee reach against flying creatures above that zone.
    - You cannot change zones while moving onto a ceiling or a wall.
    - Moving onto and being on walls or ceilings grants an extra movement along walls and ceilings (this does not translate to normal zones) — e.g. a **P** walking on the ceiling has two moves along the ceiling or in a ceiling–wall line, but you cannot use the extra move if, for example, a wall does not border another wall in the adjacent zone. Transitioning between wall and ceiling does not stack this effect.
    - You cannot make melee attacks against creatures on ceilings from the zones below them, but a creature on a ceiling may make a melee attack against an enemy below, as long as it is logical (e.g. the ceiling is not too high), and must pay **fatigue** to do so.
    - You may drop from the ceiling as part of a move if it is logical (e.g. not too high), but only into the zone directly beneath you.
    - Stepping down from a wall costs nothing, but you may only step down into a zone adjacent to that wall.
    - Walking on ceilings assumes **P** use their hands, but they may stop and attack while carrying a weapon in a sheath or in their teeth (where logical) — they do not need to draw it and are always treated as armed.
    - You cannot walk on ceilings while using a two-handed weapon.
- **Last Defense**:
    - You may sacrifice your action to attempt to avoid incoming **physical** damage. If you do, until the start of your next turn, each time you would take a hit you roll a **endurance** test with **disadvantage** for each **splinter** you currently have:
        ...
        - Partial success — you avoid max 6 damage and draw a **physical status**.
...
- **PRONE** — actions performed while prone have **disadvantage** (if it makes sense), unless the target is also prone, in which case there is no change. Attacks against a prone target have **advantage**. Standing up after being knocked down costs a move or **fatigue**, and if done in a zone where an enemy is standing, you take 2 damage. Rolling into an adjacent zone counts as movement. A prone character still counts toward **numerical advantage**. A prone **P** is moved to the end of the turn order.
- **DISARMED** — each damage die deals +1 additional damage to them (does not stack with identical effects). Disarming throws the weapon into an adjacent zone chosen by the one performing the **maneuver**. Picking up the weapon costs a move/action/(**fatigue** + **disadvantage**) (of the picker’s choice) — if the enemy has two weapons or a weapon and a shield, the one performing the **maneuver** decides which single item is knocked from their hands, but knocking away a shield does not apply the **DISARMED** condition.
- **PUSHED** — the target is moved 1 zone in a direction allowed by movement rules, and until they leave that zone, the first damage they take causes them to fall. You may push someone 2 zones by paying additional **fatigue** (this stacks with the effect of a **RAISED** zone). Pushes are always resolved in a straight line (you cannot push someone backward and then diagonally, even if pushing more than 1 zone — allowed variants are e.g. back–back or diagonal–diagonal, unless a zone blocks diagonal movement).
...
Each time **P** suffers a critical failure in combat (two ones), in addition to the normal combat effects and **splinters** (as outside of combat), they roll 1d6 according to the table below. All effects from the table last until repaired. **Arcana** cannot be damaged. For example, if **P** has an arcane weapon and mundane armor, effects that would damage the weapon have no effect.
...
- The enemy’s reaction occurs after **P** act. If that action killed the enemy who was meant to react, another one reacts — chosen by the **GM** / the next one on the **reaction tracker** — in a way that fits the narrative.
- Usually, the last roll made by **P** in their turn determines the enemy’s reaction — rarely will **P** test more than once per turn.
- If **P** roll:
  - 6 = the enemy may make a move and a narratively **failed action** (e.g. misses an attack).
  - 4–5 = the enemy performs 1 **action**. If they have 0 damage dice, they perform a **maneuver**, reposition with an additional move, or prepare a **defense** (the first attack against them before their next turn has **disadvantage**).
  - 1–3 = the enemy performs 2 **actions**.
- **Action** — e.g. dealing damage/**maneuver**/using an item/movement that creates consequences.
- If the enemy’s action is an attack, they deal damage equal to **their weapon’s damage × the number of failures (1–3)** rolled by **P** in their roll.
- Example: **P** roll a 4 and deal their damage; the enemy has no damage dice and is too far to perform a **maneuver**, so they prepare a **defense**.
- Second example: **P** roll a 3; in response, the enemy performs two **actions** — damage and a disarming **maneuver**.
- Enemies, like **P**, may buy additional **actions** using excess dice by paying HP — e.g. **P** roll 4, 2, 2, so in response to the attack the enemy may use 2 dice: one to deal damage and discard the other, paying 1 HP for it, in order to also **perform** a maneuver.
- You may give each enemy their own **special traits** (always active) and **powers** (triggered by the **main die**) that are unique to them, e.g. *moves through walls for free*, *walks on walls and ceilings*, *immune to fire*, *flies*, etc. Enemies may of course also have **powers** available to **P**.
...
- NPC Control Order (control **P** the same way):
  - **Conditions** — check whether the NPC is affected by any **conditions** that require activation.
  - **Narrative effects** — check other states affecting the NPC introduced by the narrative.
  - In chosen order: **move** — reposition the NPC according to their goal (and resolve the effect of the zone they enter) or **action**.
  - **Main die** — resolve what its result indicates (activates enemy **abilities**/zone effects/etc.).
...
- **Choosing the Enemy’s Target:**
  - Choose the target that best fits the narrative, or:
    - Determine the list of possible targets (those the enemy can realistically reach), taking tactical sense into account — some targets may be less worthwhile or not worth attacking at all.
    - Arrange them according to the current turn order of **P**.
    - Use the first **non-main die** from the left to indicate the target.
      - If there is only one die, the last in the order is always hit.
      - If the result exceeds the number of targets, loop back to the start of the list and count forward again.
      - If the **main die** shows 5–6, the enemy chooses the most logical target (e.g. the wounded, the caster, the leader).
  - **Movement and Target Choice** — the enemy moves logically toward the most sensible target. However, once in a zone with multiple possible targets, or when several are within reach (including ranged attacks), the final choice is resolved using the above mechanic. If the result does not indicate the most optimal target, interpret it as the chaos of battle.
...
| -- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| 1  | COVERED     | Ranged/magical attacks from outside this zone have **disadvantage**. End of turn: reset the ranged weapon reload counter.                                                                                                                                                                                          | wall, boulders, trees     |
...
| 6  | UNSTABLE    | A pushed in creature always falls prone if it makes sense. Taking damage knocks you prone unless you pay **fatigue**. Every failure and every 1–2 on the **main die** (5–6 for enemies) results in falling prone at the end of the turn, even if the turn does not end in that zone. | ice, narrow plank, rubble |
| 7  | SHARP       | Every failure and every 1–2 on the **main die** (5–6 for enemies) deals 1 inevitable damage.                                                                                                                                                                  | thorns, jagged rocks      |
| 8  | OBSCURED    | **Disadvantage** on attacks/magic for creatures inside and against them. Allows gaining the **HIDDEN/INVISIBLE condition** without paying **fatigue**. Grants an additional move to those affected by this **condition** (only if they already had it or by paying 1 **fatigue**). | fog, smoke, darkness      |
| 9  | CONNECTING  | Grants 1 free move to adjacent zones (according to their rules).                                                                                                                                                                | bridge, passage           |
...
| 12 | AFFECTIVE   | Start of turn: 1 **fatigue**. Grants one additional guaranteed success when casting spells (does not work two turns in a row for the same character).                                                                                                              | high pressure, dread      |
...
Supernatural beings such as dreamlike Nightmares or Giants are both extremely rare and extremely dangerous. Sometimes **P** find themselves in situations where they must - or choose to - face such a challenge far beyond their capabilities. Whether winning such a confrontation is possible, or whether escape or merely buying time is the only realistic option, is up to the **GM**. However, every such case should be played out as a **narrative sequence** or a **chase** (see *Full Rules — Other Mechanics*). Depending on the scale of the threat, the **GM** may also rule that all rolls in these narrative procedures are made with **disadvantage**.

The same approach should be used when the scale of a fight exceeds a local skirmish and involves multiple sides or large forces — in such cases, it is worth referring to *Sequential Narrative on a Time Scale*.
...
### Acting in Hiding — variants —

If, for example, **P** have broken into a place, their actions are accompanied by a clock with X segments. If the clock fills, **P** suffer appropriate narrative consequences, e.g. someone catches them and calls the guard.

Each roll advances the clock as follows:
- critical success: −2 (you cannot reduce it below zero)
- full success: no change
- partial success: +1
- failure: +2
- critical failure: +3

If a roll is not strictly required but **P** still have something left to find, the **GM** asks a question along the lines of: *you have a feeling there is something more here — do you risk checking?*  
For example, when there is a false bottom in an already opened chest that can be detected with **technology**/**investigation**.

Similarly, if there is a secret in the room, e.g. a loose floorboard hiding something underneath, the **GM** asks the same risk question. This way **P** know there is *something* there, but will not learn what it is unless they succeed at the test, which may advance the clock — giving them the option to back off when they are close to being discovered.

The same applies if **P** want to take an action that might yield something, but is not directly useful in the current situation — e.g. they find a letter and want to roll **mind** to recall where they recognize the names from. In such cases, the **GM** may ask: *you can try to think it through now, but it will cost time — do you risk it?*

Skipping a roll does not end the move. The move ends only when **P** explicitly decide to end it or when the clock fills.
...
- The group must beat a threshold of **(2 × number of P) − 1** for the test to succeed. The GM may raise or lower this threshold when appropriate, depending on whether the challenge is relatively difficult or easy.
...
- If **P** have *speed-enhancing powers* such as teleportation or temporary flight, they may use them with a limit of one use per segment to gain **advantage**. Each such use inflicts **fatigue** (even if it would normally cost more) and prevents the same **power** from being used again in later segments.
...
- The success clock cannot go below 0, but the failure clock can, to the maximum of half of the segments total rounded down.
...
| ✅ **Full success**      | **P** advance the success clock + roll **d6 × half of all segments of the success clock** (rounded down). Each 5–6 on a die reduces the **failure clock** by **1**. |

- When advancing the failure clock, the GM never rolls more dice than half of the clock’s total segments, rounded down, plus one.
    - That means:
        - 8 segments → max 5 dice
        - 7 segments → max 4 dice
        - 6 segments → max 4 dice
        - 5 segments → max 3 dice
        - 4 segments → max 3 dice
...
- **P** may use their **identities**, e.g. mobility, paying **fatigue** as normal, to grant themselves **advantage** on their test if it fits the narrative.
- **P** may use help mechanics only if they can be meaningfully woven into the narrative.
- Interaction with a trap usually consists of two rolls — **investigation** (examining) and **technology/sleight of hand** (disarming/opening) — therefore, if interacting with a trap is meant to advance clocks in a **narrative sequence**, use the examination roll for that purpose, not the disarming roll.
...
- Interaction with a trap usually consists of two rolls — investigation (examining) and technology/sleight of hand (disarming/opening). Therefore, if interacting with a trap is meant to advance clocks within a narrative sequence, resolve it using the investigation roll, not the disarming one.
- If **P** have some arcana, special items, etc. that could reasonably help them with their roll at a given stage, they may use them by paying **fatigue** (even if it would normally cost more) to gain 1 **advantage**. A specific form of assistance may be used only once per scene (e.g. the same **power** cannot be used twice). **P** incorporate the use of such assistance into the description of their action.
- If the fiction develops in a way that the characters complete their objective before the success clock is filled, simply accept it and don’t force the remaining events.
- A **Narrative Sequence** is not a mechanic for everyday obstacles or ordinary scenes. Use it when the stakes are real and high — when failure may mean death, permanent injury, the loss of a key ally, the fall of a faction, an irreversible shift in the situation, the advancement of a crucial clock, etc.. Overused, it loses its weight and stops building tension. In practice, it should appear rarely — usually once per session, maybe twice, and only when the consequences are serious. For less significant, transitional, or local scenes, use the **Pressure** mechanic instead.
...
- **Mechanics:** Success clock advances (+1). The **failure clock** has 6 empty segments, so Player A rolls **4d6** (max for **Failure Clock** of 6 segments) for failure (1–2 advance the clock).
...
- This mechanic is used to resolve scenes of lower importance than a Narrative Sequence or a Chase. It helps handle shorter connective threads between scenes, move the action from one location to another, and control the local reaction of the world based on **P**’ rolls and decisions.
- Use it when **P** are acting under pressure — breaking into someone’s house, checking cabinets behind someone’s back, running out of time, searching for someone in danger, etc. They are accompanied by an **Alarm Clock** with a number of segments equal to the number of **advancing rolls** + 1 — and when it fills, narrative consequences occur.
  - There should usually be 4–6 **advancing rolls**.
  - By design, **P** should not be able to get out of a pressured situation unless they achieve full successes, avoid all branches that offer **decisions**, or abandon the action before interacting with everything that could bring them potential value.
- This procedure may be open or hidden. If it is open, **P** should immediately know the consequences of the clock filling, or at least their type (e.g. someone catches you and calls the guard). If it is hidden, the **GM** must still know what is at stake.
- This is a time-extended procedure — **P** may move from place to place during it, even unaware that it is running in the background, but they should be aware of the situation creating the pressure (e.g. if they do not hurry, the evidence they seek will burn).
- Each test result in this procedure advances the **Alarm Clock** as follows:
  - critical success: −2 (cannot reduce below zero)
  - full success: no change
  - partial success: +1
  - failure: +2
  - critical failure: +3
- **Decisions** — moments when the **GM** tells **P** that their action reveals something more, e.g. another route, a cache, etc. Each decision comes with a question to **P** and a clear indication that it is an additional action, e.g. *you see a hidden door, but you know it does not lead toward the trail you’re following — do you check it or move on?*  
  If **P** decide to do something outside the main objective tied to the **Alarm Clock**, two things happen: the **Alarm Clock** advances by 1, and **P** should receive / be able to gain via a roll something valuable outside the clock (information/lead/loot, etc.).
  - During the procedure, there should be 1 **decision** for every 2 **advancing rolls**, rounded down. These are the only moments when **P** can advance the **Alarm Clock** beyond the rolls that define its scope, so they should be used carefully, with their dual, tempting nature in mind.
- The **GM** should have **advancing rolls** and **decisions** tied to the stakes prepared in advance.
  - Improvisation is possible, but harder.
- Side rolls that do not advance the **Alarm Clock** may occur during the procedure, such as inferring the meaning of findings (**mind**), establishing knowledge about encountered elements of the world (e.g. **nature**), or attempts by **P** to do something not directly related and not time-consuming.
- If **P** do something that clearly wastes time or is completely off-topic despite being aware of the pressure, first confirm via a question that they understand the situation, then advance the **Alarm Clock** by +1 for each such instance.
- Example:
  - **Stakes**: will they find the NPC before they die?
  - how quickly they follow the trail — **survival**.
  - **Decision** — one set of tracks veers into a narrow alley, but most lead on toward the slums; do you check it or continue?  
    If they check: clock +1 and they find a gang whistle (evidence and **advantage** for a later distraction).
  - how much noise they make opening a door — **nimble hands/technology**.
  - whether they manage to draw part of the gang away — **performance/deception**.
  - **Decision** — something glints behind a beam supporting the cellar ceiling; it might be valuable, but you don’t know how long extracting it will take. If you don’t take it now, you’ll never find it again; if you do, knives may come out before you reach your target. What do you do?  
    If they extract the treasure: clock +1 and they find 2 **treasures** and several gang outfits (allowing them to blend in).
  - whether they sneak close enough — **stealth** or **performance/deception** (preferably a **trait** not used earlier); if they have gang outfits, on a success they can approach all the way to the key NPC.
- If the procedure concerns something without a single, definitive finale — e.g. *how much information can we pull from the archive before they realize we’re here* — **P** may stop at any time to avoid further risk of filling the clock.
- If **P**’ decisions surprise the **GM** during the procedure, they may swap an **advancing roll/decision** to better fit the current narrative.
- If the scene starts to drag or the **GM** feels overloaded, shorten the procedure: reduce the number of **advancing rolls** and move to the consequences.
...
- Add an **Alarm Clock**. The clock has a number of segments equal to the number of objects +1, and **P** know this, so they can decide when to withdraw or when to push their luck. By design, **P** should not be able to check all teh objects unless they roll only full successes or ignore all secrets.
...
7. **Decotion of Intangibility** – after drinking it, you become immaterial: you can pass through walls and fly, you are invisible (though you may produce sounds if you wish), and you do not interact with the physical world (you cannot touch anything, use equipment, pick anything up, or leave anything behind). You may end the effect at any time — it can be used again only after 1 hour of real time has passed.
...
6. Grants armor/helmet/shield protection against 1 **fatigue**, which can be used once per combat at any moment — you may have a maximum of 2 such upgrades.
...
- The **P** disarms the trap using **technology/sleight of hand**:
	...
	- **Failure** — **P** roll for **critical damage** according to its rules, and on a failure they die (lose a **fate point**).
- If the trap has been triggered and was not single-use, any further attempt to disarm it requires only a roll for **technology/sleight of hand** and is always made with double **disadvantage**.
