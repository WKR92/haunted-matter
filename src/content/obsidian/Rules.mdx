...
- **Human** (see *Lore* to chose area of origin):
    - **Adaptability** - Choose any **power** and justify it narratively.
...
If exploration is meant to be more than just traveling from point A to B — an emotional scene with greater significance, such as climbing an icy mountain to light a signal fire before reinforcements arrive — it can be played in two ways:
