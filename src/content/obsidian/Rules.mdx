...
- **Priest** — you may advance **religion** to level 4. Your spells still have no cost, and in addition to a full success they also succeed when you roll 4–5 on the **main die** (this counts as a partial success, but the opponent has only 1 damage die in their reaction). You can never advance any other attribute to level 4 except **will**.
...
- **Mage** — you may advance **arcana** to level 4. On a 4–5 on the **main die**, you gain a second free success when casting spells, to be spent on spell parameters. You can never advance any other attribute to level 4 except **mind**.
