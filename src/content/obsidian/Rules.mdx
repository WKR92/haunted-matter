...
- **Priest** — requires a narrative justification: what have you done to be able to turn prayers into miracles? — you may advance **religion** to level 4. Your spells still have no cost, and in addition to a full success they also succeed when you roll 4–5 on the **main die** (this counts as a partial success, but the opponent has only 1 damage die in their reaction). You can never advance any other attribute to level 4 except **will**.
    - If you have **will** at level 4, you also succeed at casting a spell when you roll a 3 on the main die (the outcome is exactly the same as if you had rolled a 4-5 on the main die), unless the entire roll was a failure.
    - You cannot purchase this power if you already have level 4 in another attribute.
- **Mage** — requires a narrative justification: what have you done to be able to make something out of nothing? — you may advance **arcana** to level 4. On a 4–5 on the **main die**, you gain a second free success when casting spells, to be spent on spell parameters. You can never advance any other attribute to level 4 except **mind**.
    - If you have **mind** at level 4, you gain the second free success when casting spells also when you roll a 6 on the **main die**.
    - You cannot purchase this power if you already have level 4 in another attribute.
...
- Roll **arcana** or **nature** — you may use it only if you have at least 3 points in that attribute — and if you achieve at least a partial success, you add 1 extra success to your pool.
...
- A character with a magical trait at level 3, but without the Mag, Druid, or Priest **power**, may cast one spell per session. Each additional spell cast in the same session costs 3 **fatigue**.
- Spell effects cast by a character without the Mag / Druid / Priest power cannot include parameters that cost 3 or more successes.
...
| Destiny point                                                                                                                                                                      | 8         |
| Additional HP / inventory / fatigue slot (max 14 - this limit can only be exceeded by arcana)                                                                                      | 6         |
| New weapon specialization                                                                                                                                                          | 4         |
| Immunity to one chosen status (can be purchased only once)                                                                                                                         | 8         |
| New language                                                                                                                                                                       | 4         |
| Personalized **arkana** attuned to your character                                                                                                                                  | 8         |
