...
- Enemies can’t have **fatigue** — whenever they would gain it, they instead take **2 inevitable damage**.
...
- Enemies cannot have **statuses** — if they ever would, they instead take **4 inevitable damage**. they can, however, have **conditions**.
...
- A sustained effect (such as concentration, flight, or mounted riding) may be broken when the **main die** shows 5 or 6 (1–2 for enemy actions):
    ...
    - 5 = it ends if the interrupter pays **fatigue** (or 2 HP for enemies).
- **Hiding in combat:**
    - Roll **Stealth**:
...
- **CHARMED** – doesn’t affect monsters – at the start of your turn you test **will** – full success: you break the charm and act with **disadvantage**; partial: you may spend **fatigue** to break free at the end of the turn, but until then the enemy controls your movement and action, using the failures from this roll, though they act with **disadvantage**; failure: the enemy fully controls you – if you are the one who charmed them, you may give them an order as long as it doesn’t violate their values.
...
- Enemies can use **powers** just like **P**: they pay 2 HP to do so, or they may use a power when the **P** shows 1 (or 1–2 for stronger foes) on the **main die**.
