...
| Result                | Effect                                                                                                                                                            |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ❌ **Failure**         | The **P** shifts the success clock + rolls d6 × remaining failure-clock levels, where each 1–3 shifts the failure clock by 1, **OR** the **P** does **not** shift the success clock + rolls d6 × remaining failure-clock levels, where each 1–2 shifts the failure clock by 1 and a **consequence stage** appears. Which approach you use depends on the narration - e.g. if reaching failure at a given stage of the plan would make it impossible for the **P** to continue, use the variant with the **consequence stage**.
...
| ✅ **Full success**    | The **P** advances the **success clock** and rolls **d6 × half the levels of the success clock**. Each **5-6** rolled reduces the **failure clock** by **1**.|
...
- Sometimes the situation makes it hard to prepare a plan — for example when **P** escape from a prison, moving through a building where they don’t know what awaits them. In such cases, present a sequence of micro-scenes one by one — your own loose plan — ask how they intend to deal with each situation, and together decide which roll of that stage is the one that advances the clocks, treating the others as resolving the fiction but not determining the progress of the main process. Remember that the sequence should have 4 to 8 stages — you don’t need to know in advance what will happen in each one, you can improvise it as you go, but you do need to know how many rolls will advance the clocks, so you can choose the right dice pool for the rolls.
- It may happen that, on a partial success of **P**, the clocks of success and failure strike simultaneously - in such a case, **P** achieves their goal, but they must suffer some narratively relevant consequences.
